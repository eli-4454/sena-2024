...
const unsigned char epd_bitmap_play [] PROGMEM = {
    // Coloca aquí los datos de tu bitmap de "play"
};
...
void notify() {
    ...
    // Invertir el valor del joystick izquierdo para que hacia atrás sea positivo
    int scaledSpeedForward = -leftJoyY * SPEED_SCALE; // Cambiado a -leftJoyY
...
void setup() {
    ...
    Ps3.begin("00:25:56:45:0B:C3"); // Iniciar con la dirección MAC específica
